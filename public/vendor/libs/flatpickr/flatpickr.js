!(function (e, t) {
    ...
    ***************************************************************************** */ var e = function () {
                    ...
                    a = {
                        weekdays: { shorthand: ["Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"], longhand: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"] },
                        months: {
                                    ...
                                    if ("today" === u) (l = new Date()), (a = !0);
                                        ...
                                        for (var f = void 0, m = [], h = 0, v = 0, D = ""; h < s.length; h++) {
                                            ...
                                            if (p[b] && !y) {
                                                ...
                                                M && (f = !0) && m["Y" !== b ? "push" : "unshift"]({ fn: g[b], val: M[++v] });
                                            } else w || (D += ".");
                ...
                function C(n, f) {
                    ...
                    function x(e) {
                        ...
                        T(), be(), g._input.value !== t && g._debouncedChange();
                    }
                    function T() {
                        if (void 0 !== g.hourElement && void 0 !== g.minuteElement) {
                            ...
                            var r = void 0 !== g.config.minTime || (g.config.minDate && g.minDateHasTime && g.latestSelectedDateObj && 0 === b(g.latestSelectedDateObj, g.config.minDate, !0)),
                                l = void 0 !== g.config.maxTime || (g.config.maxDate && g.maxDateHasTime && g.latestSelectedDateObj && 0 === b(g.latestSelectedDateObj, g.config.maxDate, !0));
                            if (l) {
                                var c = void 0 !== g.config.maxTime ? g.config.maxTime : g.config.maxDate;
                                (n = Math.min(n, c.getHours())) === c.getHours() && (a = Math.min(a, c.getMinutes())), a === c.getMinutes() && (i = Math.min(i, c.getSeconds()));
                            }
                            if (r) {
                                var d = void 0 !== g.config.minTime ? g.config.minTime : g.config.minDate;
                                (n = Math.max(n, d.getHours())) === d.getHours() && (a = Math.max(a, d.getMinutes())), a === d.getMinutes() && (i = Math.max(i, d.getSeconds()));
                            }
                            O(n, a, i);
                        }
                    }
                    ...
                    function F() {
                        if (
                            ...
                            !(function () {
                                ...
                                S(g.mobileInput, "change", function (e) {
                                    g.setDate(e.target.value, !1, g.mobileFormatStr), ge("onChange"), ge("onClose");
                                });
                            })();
                        else {
                            var e = r(ae, 50);
                            (g._debouncedChange = r(N, M)),
                                g.daysContainer &&
                                    !/iPhone|iPad|iPod/i.test(navigator.userAgent) &&
                                    S(g.daysContainer, "mouseover", function (e) {
                                        "range" === g.config.mode && ne(e.target);
                                    }),
                                S(window.document.body, "keydown", te),
                                g.config.static || S(g._input, "keydown", te),
                                g.config.inline || g.config.static || S(window, "resize", e),
                                void 0 !== window.ontouchstart ? S(window.document, "click", Z) : S(window.document, "mousedown", P(Z)),
                                S(window.document, "focus", Z, { capture: !0 }),
                                !0 === g.config.clickOpens && (S(g._input, "focus", g.open), S(g._input, "mousedown", P(g.open))),
                                void 0 !== g.daysContainer && (S(g.monthNav, "mousedown", P(we)), S(g.monthNav, ["keyup", "increment"], _), S(g.daysContainer, "mousedown", P(se))),
                                void 0 !== g.timeContainer &&
                                    void 0 !== g.minuteElement &&
                                    void 0 !== g.hourElement &&
                                    (S(g.timeContainer, ["increment"], x),
                                    S(g.timeContainer, "blur", x, { capture: !0 }),
                                    S(g.timeContainer, "mousedown", P(j)),
                                    S([g.hourElement, g.minuteElement], ["focus", "click"], function (e) {
                    ...
                    function L(e, t, n, a) {
                        ...
                        return (
                            ...
                            -1 === e.indexOf("hidden") && 0 === b(t, g.now) && ((g.todayDateElem = o), o.classList.add("today"), o.setAttribute("aria-current", "date")),
                            i
                                ? ((o.tabIndex = -1),
                                  he(t) &&
                                      ...
                                      "range" === g.config.mode &&
                                          (c(o, "startRange", g.selectedDates[0] && 0 === b(t, g.selectedDates[0], !0)),
                                          c(o, "endRange", g.selectedDates[1] && 0 === b(t, g.selectedDates[1], !0)),
                                          "nextMonthDay" === e && o.classList.add("inRange"))))
                                : o.classList.add("disabled"),
                            "range" === g.config.mode &&
                                (function (e) {
                                    return !("range" !== g.config.mode || g.selectedDates.length < 2) && b(e, g.selectedDates[0]) >= 0 && b(e, g.selectedDates[1]) <= 0;
                                })(t) &&
                                !he(t) &&
                    ...
                    function W(e) {
                        e.focus(), "range" === g.config.mode && ne(e);
                    }
                    function R(e) {
                        ...
                        var n = ee(document.activeElement || document.body),
                            a =
                                void 0 !== e
                                    ...
                                    : void 0 !== g.selectedDateElem && ee(g.selectedDateElem)
                                    ? g.selectedDateElem
                                    : void 0 !== g.todayDateElem && ee(g.todayDateElem)
                                    ? g.todayDateElem
                                    : R(t > 0 ? 1 : -1);
                        return void 0 === a
                            ? g._input.focus()
                            ...
                            ? void (function (e, t) {
                                  for (var n = -1 === e.className.indexOf("Month") ? e.dateObj.getMonth() : g.currentMonth, a = t > 0 ? g.config.showMonths : -1, i = t > 0 ? 1 : -1, o = n - g.currentMonth; o != a; o += i)
                                      for (var r = g.daysContainer.children[o], l = n - g.currentMonth === o ? e.$i + t : t < 0 ? r.children.length - 1 : 0, c = r.children.length, d = l; d >= 0 && d < c && d != (t > 0 ? c : -1); d += i) {
                                          var s = r.children[d];
                                          if (-1 === s.className.indexOf("hidden") && X(s.dateObj) && Math.abs(e.$i - d) >= Math.abs(t)) return W(s);
                                      }
                                  g.changeMonth(i), B(R(i), 0);
                              })(a, t)
                            : W(a);
                    }
                    function K(e, t) {
                        for (
                            ...
                            o.appendChild(L(l, new Date(e, t - 1, s), s, u));
                        for (s = 1; s <= i; s++, u++) o.appendChild(L("", new Date(e, t, s), s, u));
                        for (var f = i + 1; f <= 42 - n && (1 === g.config.showMonths || u % 7 != 0); f++, u++) o.appendChild(L(c, new Date(e, t + 1, f % i), f, u));
                    ...
                    function J() {
                        if (void 0 !== g.daysContainer) {
                            ...
                            for (var e = document.createDocumentFragment(), t = 0; t < g.config.showMonths; t++) {
                                ...
                                n.setMonth(g.currentMonth + t), e.appendChild(K(n.getFullYear(), n.getMonth()));
                            }
                            g.daysContainer.appendChild(e), (g.days = g.daysContainer.firstChild), "range" === g.config.mode && 1 === g.selectedDates.length && ne();
                        }
                    }
                    function U() {
                    ...
                    function G(e, t) {
                        ...
                        (n < 0 && !0 === g._hidePrevMonthArrow) ||
                            ...
                            ((g.currentMonth += n),
                            (g.currentMonth < 0 || g.currentMonth > 11) && ((g.currentYear += g.currentMonth > 11 ? 1 : -1), (g.currentMonth = (g.currentMonth + 12) % 12), ge("onYearChange")),
                            J(),
                            ge("onMonthChange"),
                            ve());
                    }
                    ...
                    function Q(e) {
                        if (!(!e || (g.config.minDate && e < g.config.minDate.getFullYear()) || (g.config.maxDate && e > g.config.maxDate.getFullYear()))) {
                            ...
                            (g.currentYear = t || g.currentYear),
                                ...
                                n && (g.redraw(), ge("onYearChange"));
                        }
                    }
                    function X(e, t) {
                        void 0 === t && (t = !0);
                        var n = g.parseDate(e, void 0, t);
                        if ((g.config.minDate && n && b(n, g.config.minDate, void 0 !== t ? t : !g.minDateHasTime) < 0) || (g.config.maxDate && n && b(n, g.config.maxDate, void 0 !== t ? t : !g.maxDateHasTime) > 0)) return !1;
                        ...
                        if (13 === e.keyCode && t) {
                            ...
                            switch (e.keyCode) {
                                ...
                                case 39:
                                    ...
                                    else if ((e.preventDefault(), void 0 !== g.daysContainer && (!1 === n || (document.activeElement && ee(document.activeElement))))) {
                                        var r = 39 === e.keyCode ? 1 : -1;
                                        e.ctrlKey ? (e.stopPropagation(), G(r), B(R(1), 0)) : B(void 0, r);
                                    }
                                    break;
                                case 38:
                                case 40:
                                    ...
                                    (g.daysContainer && void 0 !== e.target.$i) || e.target === g.input
                                        ? e.ctrlKey
                                            ? (e.stopPropagation(), Q(g.currentYear - l), B(R(1), 0))
                                            : o || B(void 0, 7 * l)
                        ...
                        if (void 0 !== g.amPM && e.target === g.amPM)
                            switch (e.key) {
                                ...
                                case g.l10n.amPM[0].charAt(0).toLowerCase():
                                    (g.amPM.textContent = g.l10n.amPM[0]), T(), be();
                                    break;
                                case g.l10n.amPM[1].charAt(0):
                                case g.l10n.amPM[1].charAt(0).toLowerCase():
                                    (g.amPM.textContent = g.l10n.amPM[1]), T(), be();
                            }
                        ge("onKeyDown", e);
                    }
                    function ne(e) {
                        if (1 === g.selectedDates.length && (!e || (e.classList.contains("flatpickr-day") && !e.classList.contains("disabled")))) {
                            for (
                                ...
                                X(new Date(d), !0) || ((r = r || (d > a && d < i)), d < n && (!l || d > l) ? (l = d) : d > n && (!c || d < c) && (c = d));
                                            ...
                                            return p
                                                ...
                                                : (["startRange", "inRange", "endRange", "notAllowed"].forEach(function (e) {
                                                  ...
                                                  void (
                                                      ...
                                                      (!u.contains(e) && s > 0 && f && f.lastChild.dateObj.getTime() >= m) ||
                                                          (n < t && m === n ? o.classList.add("startRange") : n > t && m === n && o.classList.add("endRange"), m >= l && (0 === c || m <= c) && w(m, n, t) && o.classList.add("inRange")))
                                                  ));
                                        },
                                        p = 0,
                                        h = u.children.length;
                    ...
                    function ie() {
                        g.setDate(void 0 !== g.config.minDate ? new Date(g.config.minDate.getTime()) : new Date(), !1), I(), be();
                    }
                    function oe(e) {
                        return function (t) {
                                    ...
                                    if (((g.calendarContainer.style.top = u + "px"), p))
                                        if (h) {
                                            ...
                                            var D = window.document.body.offsetWidth,
                                                b = Math.max(0, D / 2 - a / 2),
                                                w = v.cssRules.length,
                                                y = "{left:" + l.left + "px;right:auto;}";
                                            c(g.calendarContainer, "rightMost", !1),
                                                c(g.calendarContainer, "centerMost", !0),
                                                v.insertRule(".flatpickr-calendar.centerMost:before,.flatpickr-calendar.centerMost:after" + y, w),
                                                (g.calendarContainer.style.left = b + "px"),
                    ...
                    function ce() {
                        g.config.noCalendar || g.isMobile || (ve(), J());
                    }
                    function de() {
                        ...
                        if (void 0 !== t) {
                            ...
                            if (((g.selectedDateElem = n), "single" === g.config.mode)) g.selectedDates = [a];
                                ...
                                "range" === g.config.mode &&
                                    ...
                                    0 !== b(a, g.selectedDates[0], !0) &&
                                        g.selectedDates.sort(function (e, t) {
                                            return e.getTime() - t.getTime();
                                        }));
                            if ((T(), i)) {
                                var r = g.currentYear !== a.getFullYear();
                                (g.currentYear = a.getFullYear()), (g.currentMonth = a.getMonth()), r && ge("onYearChange"), ge("onMonthChange");
                            }
                            if (
                                (ve(),
                                J(),
                                ...
                                i || "range" === g.config.mode || 1 !== g.config.showMonths ? void 0 !== g.selectedDateElem && void 0 === g.hourElement && g.selectedDateElem && g.selectedDateElem.focus() : W(n),
                    ...
                    (g.parseDate = D({ config: g.config, l10n: g.l10n })),
                        ...
                        (g.open = function (e, t) {
                            if ((void 0 === t && (t = g._positionElement), !0 === g.isMobile))
                                return e && (e.preventDefault(), e.target && e.target.blur()), void 0 !== g.mobileInput && (g.mobileInput.focus(), g.mobileInput.click()), void ge("onOpen");
                            if (!g._input.disabled && !g.config.inline) {
                                var n = g.isOpen;
                                (g.isOpen = !0),
                                    n || (g.calendarContainer.classList.add("open"), g._input.classList.add("active"), ge("onOpen"), le(t)),
                        ...
                        (g.setDate = function (e, t, n) {
                            ...
                            fe(e, n), (g.showTimeInput = g.selectedDates.length > 0), (g.latestSelectedDateObj = g.selectedDates[0]), g.redraw(), A(), k(), be(t), t && ge("onChange");
                        }),
                        (g.toggle = function (e) {
                            if (!0 === g.isOpen) return g.close();
                            g.open(e);
                        });
                    var ue = { locale: [re, z], showMonths: [q, C, $] };
                    function fe(e, t) {
                        var n = [];
                    ...
                    function he(e) {
                        for (var t = 0; t < g.selectedDates.length; t++) if (0 === b(g.selectedDates[t], e)) return "" + t;
                        return !1;
                    }
                    function ve() {
                        g.config.noCalendar ||
                    ...
                    function be(e) {
                        ...
                        void 0 !== g.mobileInput && g.mobileFormatStr && (g.mobileInput.value = void 0 !== g.latestSelectedDateObj ? g.formatDate(g.latestSelectedDateObj, g.mobileFormatStr) : ""),
                            (g.input.value = De(g.config.dateFormat)),
                            void 0 !== g.altInput && (g.altInput.value = De(g.config.altFormat)),
                    ...
                    return (
                        (function () {
                            (g.element = g.input = n),
                                ...
                                (function () {
                                    ...
                                    i.dateFormat || (!i.enableTime && !r) || (o.dateFormat = i.noCalendar || r ? "H:i" + (i.enableSeconds ? ":S" : "") : E.defaultConfig.dateFormat + " H:i" + (i.enableSeconds ? ":S" : "")),
                                        i.altInput &&
                                            (i.enableTime || r) &&
                                            !i.altFormat &&
                                            (o.altFormat = i.noCalendar || r ? "h:i" + (i.enableSeconds ? ":S K" : " K") : E.defaultConfig.altFormat + " h:i" + (i.enableSeconds ? ":S" : "") + " K"),
                                ...
                                g.isMobile || H(),
                                F(),
                                (g.selectedDates.length || g.config.noCalendar) && (g.config.enableTime && k(g.config.noCalendar ? g.latestSelectedDateObj || g.config.minDate : void 0), be(!1)),
                                C(),
                                (g.showTimeInput = g.selectedDates.length > 0 || g.config.noCalendar);
                            var a = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
                            !g.isMobile && a && le(), ge("onReady");
                        })(),
                        g
                    );
                }
    ...
    if ("object" == typeof n) {
        var a = ["object" == typeof module && "object" == typeof module.exports ? module.exports : null, "undefined" != typeof window ? window : null, e && e !== window ? e : null];
        for (var i in n) a[0] && (a[0][i] = n[i]), a[1] && "__esModule" !== i && (a[1][i] = n[i]), a[2] && (a[2][i] = n[i]);
    }
})(this);
