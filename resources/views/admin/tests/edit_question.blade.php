...
<form method="POST" name="question_form_edit" action="/adm/tests/{{$test->id}}/update_question/{{$question->id}}">
  @csrf
        ...
        <thead>
          ...
          <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><input class="form-control form-control-lg" type="checkbox" name="c_r[{{$answer->id}}]" {{$answer->right == 1 ? "checked" : ""}}></input></td>
                </tr>
